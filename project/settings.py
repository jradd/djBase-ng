...
DATABASES = {
    'default': {
        ...
        'NAME': 'tristanodb',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'docker',
        'PASSWORD': 'docker',
        'HOST': '172.17.0.101',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
